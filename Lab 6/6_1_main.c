...
int main(void)
{
  ...
  /* add threads, ... */
  osThreadNew(led1_thread, NULL, &led1Task_attributes);
    osThreadNew(led2_thread, NULL, &led2Task_attributes);
    osThreadNew(led3_thread, NULL, &led3Task_attributes);
    osThreadNew(led4_thread, NULL, &led4Task_attributes);
